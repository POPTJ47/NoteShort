...
public class UseText extends MainActivity implements OnInitListener, OnUtteranceCompletedListener, MyDialogFragment.MyDialogListener{
	...
	private Button mTranslateButton, mTTSButton, mSaveButton, mSummarizeButton;
	...
	private void setupUI(){        
        ...
        mSummarizeButton = (Button)findViewById(R.id.button_summarize);
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		//this is for summarize button action
		//addListenerOnButton();
		...
		mSummarizeButton.setOnClickListener(new View.OnClickListener() {
			public void onClick(View arg0) {
				...
				Intent myIntent = new Intent(UseText.this,
