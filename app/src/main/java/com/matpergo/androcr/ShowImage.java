...
public class ShowImage extends MainActivity implements MyDialogFragment.MyDialogListener {
    	...
    	switch(dialog_id){
    		...
    		case SEGMODE_DIALOG:
    	    	...
    	    	case 1:    		
    	    		...
    	    		break;
    	    	case 2:
    	    		mSegMode = TessBaseAPI.PageSegMode.PSM_SINGLE_LINE;
    	    		break;
    	    	case 3:
    	    		mSegMode = TessBaseAPI.PageSegMode.PSM_SINGLE_WORD;
    	    		break;
    	    	case 4:
    	    		mSegMode = TessBaseAPI.PageSegMode.PSM_SINGLE_CHAR;
    	    		break;
    	    	case 5:
    	    		mSegMode = TessBaseAPI.PageSegMode.PSM_SINGLE_BLOCK_VERT_TEXT;
    	    		break;        	    	
    	    	}        	    	
    ...
    */
    ...
    private void restorePreferences(){
        ...
        mSegMode = settings.getInt("segmode", TessBaseAPI.PageSegMode.PSM_AUTO);
